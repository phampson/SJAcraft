...
<div class="div1 col-sm-8 col-sm-offset-2 col-xs-12 col-xs-offset-0" id="border-gold" style="padding: 0px;">
	...
	<div class="container col-xs-12 col=xs-offset-0 col-sm-8 col-sm-offset-2" id="btmcntr">
		...
		<div class="container col-sm-12 col-sm-offset-0 col-xs-12 col-xs-offset-0" id="downloadButton" class="container">
		</div>
	</div>
</div>
